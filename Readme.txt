There are three folders containing different file types. The CAD-models that can be imported into Fusion360, the exported STL Files that are ready to be sliced and the sliced G-Code files. 
